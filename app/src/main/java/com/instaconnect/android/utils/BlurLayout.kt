...
import com.instaconnect.android.utils.BlurKit.Companion.getInstance
import com.instaconnect.android.utils.BlurKit.Companion.init
...
class BlurLayout : FrameLayout {
    ...
    private fun blur(): Bitmap? {
        ...
        // Blur the bitmap.
        bitmap = getInstance()!!.blur(bitmap!!, mBlurRadius)
    ...
    companion object {
        const val DEFAULT_DOWNSCALE_FACTOR = 0.36f
